package com.caresofts.edumeet.schedule;
...
import com.caresofts.edumeet.bean.Schedule;
...
import com.caresofts.edumeet.utils.SimpleDividerItemDecoration;
...
//           compareResult = arg0.compareTo(arg1);
            ...
            scheduleAdapter.setOnItemClickListener(new ScheduleAdapter.OnItemClickListener() {
                ...
                public void onShareClickListener(int position, Schedule bean) {
                    ...
                    shareMessage = shareMessage + "\n\n" +"Meeting Code :"+  bean.getMeeetingId()  + "\n\n";
    ...
    public void showMeetingShareDialog() {
        ...
        Cshare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Edu Meet App");
                String shareMessage = "\nDownload this cool app For Online Meetings and Classrooms \n" +"https://play.google.com/store/apps/details?id="+ appPackageName + " \n\n Meeting Id:\n"+AppConstants.MEETING_ID    ;
                shareMessage = shareMessage + "\n\n" + getString(R.string.hostlink)+AppConstants.MEETING_ID  + "\n\n";
                shareIntent.putExtra(Intent.EXTRA_TEXT, shareMessage);
                startActivity(Intent.createChooser(shareIntent, "choose one"));
            }
        });
